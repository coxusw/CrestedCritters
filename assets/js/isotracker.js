const STORAGE = "isoTrackerData_v5";
...
function renderShell(activeTab, contentHtml) {
  document.getElementById("isoApp").innerHTML = `
    ...
    <div class="iso-tabs">
      ...
      <div class="iso-tab ${activeTab === "settings" ? "active" : ""}" onclick="renderSettings()">Settings</div>
    </div>
...
function renderGuide() {
  renderShell("guide", `
    ...
    <div class="iso-grid-auto">
      ...
      <div class="iso-card">
        <h3>5. Settings Tab</h3>
        <p class="iso-muted">Backup and restore tools, demo loading, and full data clearing are all found in the Settings tab to keep the Colonies view clean.</p>
      </div>

      <div class="iso-card">
        <h3>6. Price Sheet Rules</h3>
...
function renderSettings() {
  renderShell("settings", `
    ...
    <p class="subtext">Manage backups, restore data, test with demo data, or clear everything from here.</p>

    <div class="iso-section-box">
      <h3 style="margin-top:0;">Backup & Restore</h3>
      <p class="iso-muted" style="margin-top:0;">
        Export saves all colonies, botanicals, price sheet settings, sections, order, and logos into one backup file.
      </p>
      <div class="iso-toolbar">
        <button class="iso-btn iso-btn-primary" onclick="exportBackup()">Export Backup</button>
    ...
    <div class="iso-section-box">
      <h3 style="margin-top:0;">Testing & Reset</h3>
      <p class="iso-muted" style="margin-top:0;">
        Load demo content to test the app flow, or clear all saved data from this device.
      </p>
      <div class="iso-toolbar">
