      ...
      <div class="iso-guide-grid">
        <div class="iso-guide-card">
          ...
          <div class="iso-guide-visual">
            <svg viewBox="0 0 420 220" xmlns="http://www.w3.org/2000/svg">
              ...
              <rect x="18" y="18" width="384" height="184" rx="18" fill="#1c2d23" stroke="rgba(255,255,255,.08)"/>
              <rect x="34" y="36" width="150" height="26" rx="8" fill="#e2c17f"/>
              <rect x="34" y="78" width="170" height="18" rx="6" fill="#2c4236"/>
              <rect x="216" y="78" width="170" height="18" rx="6" fill="#2c4236"/>
              <rect x="34" y="110" width="170" height="18" rx="6" fill="#2c4236"/>
              <rect x="216" y="110" width="170" height="18" rx="6" fill="#2c4236"/>
              <rect x="34" y="144" width="352" height="32" rx="10" fill="#2c4236"/>
              <rect x="34" y="186" width="120" height="12" rx="6" fill="#7bbd95"/>
            </svg>
          </div>
        </div>
        ...
        <div class="iso-guide-card">
          ...
          <div class="iso-guide-visual">
            <svg viewBox="0 0 420 220" xmlns="http://www.w3.org/2000/svg">
              <rect width="420" height="220" fill="#112018"/>
              <rect x="18" y="18" width="384" height="184" rx="18" fill="#1c2d23"/>
              <rect x="32" y="42" width="160" height="24" rx="10" fill="#e2c17f"/>
              <rect x="32" y="84" width="160" height="28" rx="10" fill="#2b6b4e"/>
              <rect x="208" y="84" width="160" height="28" rx="10" fill="#2b6b4e"/>
              <rect x="32" y="124" width="160" height="28" rx="10" fill="#2b6b4e"/>
              <rect x="208" y="124" width="160" height="28" rx="10" fill="#2b6b4e"/>
            </svg>
          </div>
        </div>
        ...
        <div class="iso-guide-card">
          ...
          <div class="iso-guide-visual">
            <svg viewBox="0 0 420 220" xmlns="http://www.w3.org/2000/svg">
              <rect width="420" height="220" fill="#112018"/>
              <rect x="24" y="26" width="372" height="40" rx="14" fill="#1e3025"/>
              <rect x="24" y="78" width="372" height="40" rx="14" fill="#1e3025"/>
              <rect x="24" y="130" width="372" height="40" rx="14" fill="#1e3025"/>
              <circle cx="54" cy="46" r="10" fill="#d6bb7b"/>
              <circle cx="54" cy="98" r="10" fill="#d6bb7b"/>
              <circle cx="54" cy="150" r="10" fill="#d6bb7b"/>
            </svg>
          </div>
        </div>
        ...
        <div class="iso-guide-card">
          ...
          <div class="iso-guide-visual">
            <svg viewBox="0 0 420 220" xmlns="http://www.w3.org/2000/svg">
              <rect width="420" height="220" fill="#112018"/>
              <rect x="18" y="18" width="384" height="184" rx="18" fill="#1c2d23"/>
              <rect x="32" y="34" width="356" height="36" rx="12" fill="#2a4034"/>
              <rect x="32" y="82" width="356" height="36" rx="12" fill="#2a4034"/>
              <rect x="32" y="130" width="356" height="36" rx="12" fill="#2a4034"/>
              <text x="52" y="57" fill="#f0dbab" font-size="18">☰</text>
              <text x="52" y="105" fill="#f0dbab" font-size="18">☰</text>
              <text x="52" y="153" fill="#f0dbab" font-size="18">☰</text>
            </svg>
          </div>
        </div>
